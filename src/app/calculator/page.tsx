  ...
  return (
    <>
      ...
      <main className="flex min-h-screen dark:bg-dark bg-gray-200 justify-center items-center py-8">
        <div className="flex flex-col md:flex-row w-80 md:w-auto md:max-w-4xl">
          <div className="bg-gray-600 p-4 rounded-lg shadow-lg mb-4 md:mb-0 md:mr-4 md:w-3/5">
            <input
              type="text"
          ...
          <div className="bg-gray-600 p-4 rounded-lg shadow-lg md:w-2/5">
